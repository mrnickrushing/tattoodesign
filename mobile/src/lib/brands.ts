...
export type BrandConfig = {
  ...
  generate: {
     ...
     * cookie, so Sugar Haus does without rather than being shown five ways to
     * build tone it will never use.
     */
    offersShading: boolean;
    subjectFraming: string;
    outputFraming: string;
  };
  convert: { tabLabel: string; title: string; subtitle: string };
  builder: { tabLabel: string; title: string; subtitle: string };
};
...
export const BRANDS: Record<BrandId, BrandConfig> = {
  ink: {
    ...
    home: {
      cards: [
        ...
        },
        {
          ...
          blurb:
            "Drop in a photo, get back tattoo-ready line art. Runs edge detection right on your phone and lets you dial in the line weight.",
          cta: "Convert a photo",
        },
        {
          tool: "builder",
    ...
    convert: {
      ...
      subtitle:
        "Drop in a reference photo. Everything runs locally on your phone — edge detection turns it into clean tattoo-ready line art.",
    },
    builder: {
      tabLabel: "Sheet",
      title: "Lay out a flash sheet",
      subtitle:
        "Drag designs onto the sheet, resize and rotate them, then export or print at true size.",
    },
  },
  ...
  sugar: {
    ...
    home: {
      cards: [
        ...
        },
        {
          ...
          blurb:
            "Drop in a photo, get back bake-ready line art. Runs edge detection right on your phone and lets you dial in the line weight.",
          cta: "Convert a photo",
        },
        {
          tool: "builder",
    ...
    convert: {
      ...
      subtitle:
        "Drop in a reference photo or sketch. Everything runs locally on your phone — edge detection turns it into clean icing-ready line art.",
    },
    builder: {
      tabLabel: "Sheet",
